...
| [自動詞と他動詞](#自動詞と他動詞) | 自動詞(目的語が必須ではない、目的語を持つ場合は前置詞が必須)、他動詞(目的語が必須、前置詞を付けてはいけない) |
...
## 否定形
* 文章全体を「～でない」の意味で否定することを指す
* 基本の否定形
    * I do not use a laptop. 私はノートパソコンを使いません。
    * He does not use a laptop. 彼はノートパソコンを使いません。
    * We do not use a laptop. 私たちはノートパソコンを使いません。
* 完了表現の否定形
    * I have not done today's report. 私は今日のレポートが終わっていない。
* 名詞表現を使った否定形
    * NoやNoneを使うことで、「ゼロの」の意味でnotを使わずに否定の表現をすることができる
        * We have no tickets. 私たちはゼロ枚のチケットを持っている/私たちはチケットを持っていない
        * None of us came to see her. 私たちのうちゼロ人は彼女に会いに行った/私たちの中で彼女に会いに行った人はいない
    * Nobody, No one, Nothingなどの語句にはすでに、否定の意味が含まれているので、notを使う必要がない
        * Nobody responded. 誰も返事をしなかった。
        * No one can remember his name. 彼の名前を覚えられる人はいない。
        * He is consultant who knows nothing about your industry. 彼はあなたの業界について何も知らないコンサルタントだ。
    * Neitherを使うことで、2つ以上の名詞にnotを使わず、否定表現にできる
        * Neither my mother nor I speak English. 私の母と私はどちらも英語を話さない。
* 副詞表現を使った否定形
    * Neverを使うことで、notを使わずに否定の表現をすることができる
        * I have never been to Japan. 私は日本に行ったことがない。
    * Nowhereを使うことで、notを使わずに否定の表現をすることができる
        * There was nowhere to sit. 座れるところがどこにもない。
    * Neitherは否定形の文章への返答として使うこともある
        * I have never been to Japan. 私は日本に行ったことがありません。
        * Me neither. 私もありません。
* To不定詞の否定形
...
* 疑問文の否定形
    * 疑問文を否定形資する場合は、短縮形を使う
    * Don't you think the project is going well? そのプロジェクトがうまくいっていると思わないですか？
    ...
    * 否定の疑問文への回答は、回答の内容が肯定であればYes, 否定の内容であればNoと答える
    * Don't you do your homework?  あなたは宿題をやっていないですよね。
        * Yes, I did. 私はやりました。
        * No, I didn't. 私はやっていません。
* 否定の接頭辞
    * 単語の頭に特定の接頭辞を使うことで、その単語に否定的な意味を加えることができる
    * 動詞
        * de- 否定・下降
            * devalue 価値を減じる
        * dis- 反対・欠如
...
## 疑問文
* 語句や平叙文（通常の文)
    * 内容を確認したり、聞き返すなど、ソフトな質問が多い
    * 語尾のイントネーションを上げることで、質問のニュアンスに変化する
        * I visited Tokyo last week.
            * Last week? (後ろのイントネーションを上げる)
        * You need help? (後ろのイントネーションを上げる)
* 付加疑問文
    * 語尾にdon't youなどのパーツをつけて、同意や確認を求める
        * It is quite cold, isn't it? 寒いですよね?
        * The exam was not that easy, was it? その試験は簡単ではなかったですよね?
* 間接疑問文
    * 平叙文の中に疑問文を埋め込む用法
        * Tell me who is involve in the training program. トレーニングプログラムに誰が含まれるのか教えてください。
        * Do you have any idea why the sales have increased by 10 percent? なぜ売り上げが10%増加していると思いますか?
    * 関節疑問文は、Yes-No疑問文やWH疑問文と異なり、主語・動詞の倒置が起こらない
        * Why is she absent today? 彼女はなぜ今日休みなのですか?
        * I'm wondering why she is absent today. 彼女はなぜ休みなのかと考えています。
    * 関節疑問文は、疑問視を使うが、必ずしも明確な答えを期待しているとは限らない
...
* Yes-No疑問文
    * YesあるいはNoで答えられる疑問文
        * Have you finished your report? レポートは終わりましたか?
            * Yes, I have.
            * No, not yet.
        * Yes/Noを使わずに間接的に返答することもできる
            * I have already submitted it to the management team. すでにマネジメントチームに提出しました。
    * Yes-No疑問文は、状況によって提案や依頼を意味する
        * Can we share the computer together? 提案:このパソコンを共有しませんか?
        * Could you please review my draft? 依頼: 私の原稿をレビューしていただけませんか？
        * 提案や依頼はYes/Noのほか、間接的に返答できる
            * Yes, of course.
            * Ah, I have something to do today. 私は今日やらなければならないことがある(だからできない)
* 選択疑問文
    * 複数の選択肢を提示し、その中から1つ(あるいは2つ以上)を選ばせるよう用法
        * Would you like coffee or tea? コーヒーと紅茶のどちらがいいですか?
        * Shall we take a break, or do you want to finish it now? 休憩をとりますか?あるいはそれを今終えたいですか?
    * 洗濯疑問文は相手に「選択」させるから、Yes/Noでは答えられない
        * I'd like tea please. 私は紅茶がいいです。
        * Either is fine with me. 私はどちらでも構いません。
* WH疑問文
    * WH語(What, Which, Why, Where, Who, How)を使った疑問文
        * Whatはヒトやモノに関する不特定の情報を尋ねる
            * What happned? 何が起こったの？
        * Whoはヒトについて尋ねる
            * Who made that decision? その決定をしたのは誰ですか?
        * Whoseは所有者について尋ねる
            * Whose bag is this? このバッグは誰のものですか?
        * Whichは特定のヒト・モノについて尋ねる
            * Which is the best computer for me? 私にとってベストなコンピュータはどれですか?
        * Whenは時について尋ねる
        ...
        * Why not..? は提案をするのに使われる
            * 「なぜ～しないの？」と「～したらいかがですか？」の両方の解釈がある
            * I can't do my assignment now. 私は課題を今できない。
                * Why not? なぜしないの？
            * We have some time. Why not go to the beach? 私たちは時間がある。ビーチに行かないか？
        * Howは方法について尋ねる
            * How do I get to the train station? 駅にはどうやって行けばいいですか?
        * Howは形容詞や福祉と共に使うことで、程度について尋ねる
