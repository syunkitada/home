...
## 概要
* IPv4とIPv6は別物で互換性はなく、IPv6対応とは両者デュアルスタック環境で運用するということ
* DNSがIPv4とIPv6を返した場合にクライアントはどちらのプロトコルを使うかを選択する
...
## IPv6とセキュリティ
* IPv6は新しいが、IPv4よりもセキュアである刷毛ではない
* むしろ新しく運用実績も少ないので、IPv4よりもセキュリティについては劣るともいえる
