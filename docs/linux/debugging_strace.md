...
- `ss` の拡張情報からソケット inode で検索して接続先を発見する
...
# -e で拡張情報（inode など）を表示する
$ sudo ss -anpe | grep 'ino:1148032788'
ESTAB 0 0 10.0.0.10:44566 10.0.0.11:3306 users:(("example",pid=10471,fd=58)) ino:1148032788
```
